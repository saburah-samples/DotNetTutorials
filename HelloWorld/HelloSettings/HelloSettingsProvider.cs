...
namespace HelloSettings
{
    ...
    /// </summary>
    public class HelloSettingsProvider : SettingsProvider, IApplicationSettingsProvider
    {
        ...
        {
            return new System.IO.FileInfo(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData)).DirectoryName;
        ...
        {
            System.Diagnostics.Trace.WriteLine("IApplicationSettingsProvider.GetPreviousVersion");
            return new SettingsPropertyValue(property);
        }

        public void Reset(SettingsContext context)
        {
            System.Diagnostics.Trace.WriteLine("IApplicationSettingsProvider.Reset");
        }

        public void Upgrade(SettingsContext context, SettingsPropertyCollection properties)
        {
            System.Diagnostics.Trace.WriteLine("IApplicationSettingsProvider.Upgrade");
        } 
        #endregion
    }
}
